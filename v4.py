...
for i in range(no_bins):
    ...
    if (E < 120 or E > 130) and (E < 137 or E > 147):
        sideband_E.append(E)
...
#fit polynomial
popt,pcov = curve_fit(pol,sideband_E,sideband_data,sigma=side_ers)
p0,p1,p2,p3 = popt
print("p0 = ",p0,"\np1 = ",p1,"\np2 = ",p2,"\np3 = ",p3)

#polynomial errors
perr = np.sqrt(np.diag(pcov))
del_1,del_2,del_3 = perr
...
popt,pcov = curve_fit(gauss,E_index,data_minus_bkg,p0=[max_y,125,2])
a, mean, sigma = popt
print("amp value: ",a,"\nMean: ",mean,"\nStd: ",sigma)
